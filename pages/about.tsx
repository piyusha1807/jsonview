          ...
          <main className={style.mainContent}>
            ...
            <section className={style.profileSection}>
              ...
              <Flex direction="column" justify="space-between" gap={20} sx={{ height: '100%' }}>
                <Text>
                  👋 Hello! I'm Piyush Agrawal, a full-stack developer driven by a passion for
                  community and innovation. I created JSON Viewer to empower developers like you,
                  enhancing coding efficiency and collaboration across projects. Let's connect and
                  grow together!
                </Text>
                <Link
                  target="_blank"
